    ...
    override fun buildVisitor(holder: ProblemsHolder, isOnTheFly: Boolean): PsiElementVisitor {
        return object : LuaVisitor() {
            override fun visitBinaryOp(o: LuaBinaryOp) {
                if (o.languageLevel < LuaLanguageLevel.LUA51 && LuaParserDefinition.LUA52_BIN_OP_SET.contains(o.node.firstChildNode.elementType)) {
            ...
            override fun visitUnaryOp(o: LuaUnaryOp) {
                if (o.languageLevel < LuaLanguageLevel.LUA51 && LuaParserDefinition.LUA52_UNARY_OP_SET.contains(o.node.firstChildNode.elementType)) {
